...
def creador_xml_metadata(file_identifier, specificUsage, wmsLayer, miniature_url, organization_name, email_address, date_stamp, title, publication_date, west_bound, east_bound, south_bound, north_bound, spatial_resolution, protocol, wms_link, layer_name, layer_description):
 ...
 # fileIdentifier
    ...
    descriptiveKeywords2 = ET.Element("gmd:descriptiveKeywords", xmlns="http://www.isotc211.org/2005/gmd")
    ...
    gmx_anchor2 = ET.SubElement(keyword_anchor, "gmx:Anchor", {"xlink:href": "http://inspire.ec.europa.eu/theme/oi"})
    gmx_anchor2.text = "Ortoimágenes"

    # Add type element
    type_element = ET.SubElement(md_keywords2, "gmd:type")
    ...
    thesaurus_name = ET.SubElement(md_keywords2, "gmd:thesaurusName")
    ...
    title_anchor.text = "Temas INSPIRE"
