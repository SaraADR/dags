...
#CONFIGURATION_PATH={configuration_path}
            command = (
                f' cd /home/admin3/algoritmo_rutas_escape/launch &&  docker-compose -f compose.yaml up --build --abort-on-container-exit && docker-compose -f compose.yaml down --volumes'
            )
