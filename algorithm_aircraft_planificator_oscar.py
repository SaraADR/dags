...
def list_server_directory(**context):
    ...
    try:
        ...
        stdin, stdout, stderr = client.exec_command(f'ls -l {target_directory}')
        ...
        if error:
            ...
            print(f"[LISTING] Contenido de {target_directory}:\n{output}")
...
dag = DAG(
    'list_server_structure',
    default_args=default_args,
    description='DAG para listar estructura de carpetas en el servidor Avincis',
    schedule_interval=None,
    catchup=False,
)

list_directory_task = PythonOperator(
    task_id='list_server_directory',
    python_callable=list_server_directory,
