...
def process_and_generate_video_thumbnails(**kwargs):
    ...
    for video_key in videos:
        ...
        thumbnail_key = os.path.join("tmp/thumbs", os.path.basename(video_key).replace('.mp4', 'thumb.jpg'))
...
def process_and_generate_image_thumbnails(**kwargs):
    ...
    for image_key in images:
        ...
        thumbnail_path = os.path.join(temp_dir, "thumbs.jpg")
        thumbnail_key = os.path.join("tmp/thumbs", os.path.basename(image_key).replace('.jpg', 'thumb.jpg'))
